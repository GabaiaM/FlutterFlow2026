      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(20.0, 155.0, 20.0, 0.0),
                child: Container(
                    ...
                    children: [
                      Align(
                        ...
                        child: TabBar(
                          ...
                          indicatorColor: Color(0xFF65784F),
                          tabs: [
                            Tab(
                              text:
                                  'Informe o código de verifcação que foi \nenviado para o seu e-mail informado:',
                            ),
                          ],
